<div id="pokedex">
    <div id="left">
        ...
        <div id="screen">
            ...
            <div id="picture">
                ...
                <img src="<?php echo $pokemon["imagen_path"] ?>" alt="<?php echo $pokemon["nombre"] ?>" height="170" />
            </div>
    ...
    <div id="right">
        <div id="stats">
            <strong>Nombre:</strong> <?php echo $pokemon["nombre"] ?> <strong>#<?php echo $pokemon["numero_identificador"] ?></strong><br/>
            <strong>habitad:</strong> <?php echo $pokemon["habitad"] ?><br/>
            <strong>Tipo:</strong> <?php echo $pokemon["tipo"] ?><br/>
            <strong>Altura:</strong> <?php echo $pokemon["altura"] ?><br/>
            <strong>Peso:</strong> <?php echo $pokemon["peso"] ?><br/><br/>
            <strong><?php echo $pokemon["habilidad"] ?></strong><br/>
